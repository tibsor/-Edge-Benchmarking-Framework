...
def get_files(root, test=False):
    ...
    dataset1 = '/home/tibs/Work/DL-based-Intelligent-Diagnosis-Benchmark/MFPT_fault_data_sets/6 - Real World Examples/IntermediateSpeedBearing.mat'  # 'Three Baseline Conditions'
