...
def get_files(root, test=False):
    ...
    root1 = os.path.join("/tmp",root,os.listdir(root)[1],datasetname[0]) #Path of bearingset
    root2 = os.path.join("/tmp",root,os.listdir(root)[1],datasetname[1]) #Path of gearset
